...
#Const IDE_PROTECTION_ENABLED = 0 ' you can set it to 0 if you compile it into an OCX or EXE if you want, but anyway it shouldn't be neccesary since the IDE protection code won't get compiled anyway
